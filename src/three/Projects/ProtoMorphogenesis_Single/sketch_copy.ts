...
//     // This function is called once the texture is fully loaded
//     const width = texture.image.width;
//     const height = texture.image.height;

//     // Now you can proceed to use the texture
//     console.log('Texture loaded with width:', width, 'and height:', height);
//     // Proceed with further rendering or processing
...
// const geometry = protoOrg.body.mesh.geometry;
// const uvAttribute = geometry.attributes.uv;

// // Assuming `vertexIndex` is the index of your vertex
// const vertexIndex = 10;
// const uvIndex = vertexIndex * 2;
// const u = uvAttribute.array[uvIndex];
// const v = uvAttribute.array[uvIndex + 1];
// console.log("u = ", u);
// console.log("v = ", v);

// const pixelRenderer = new WebGLRenderer();
// if (textureMid) {
//     renderer.setSize(textureMid.image.width, textureMid.image.height);
//     renderer.render(scene, camera);
// }

// // Create a framebuffer to read the texture
// const framebuffer = renderer.getContext().createFramebuffer();
// renderer.getContext().bindFramebuffer(renderer.getContext().FRAMEBUFFER, framebuffer);
// renderer.getContext().framebufferTexture2D(renderer.getContext().FRAMEBUFFER, renderer.getContext().COLOR_ATTACHMENT0, renderer.getContext().TEXTURE_2D, textureMid, 0);

// const pixelBuffer = new Uint8Array(4); // RGBA
// renderer.getContext().readPixels(u * textureMid.image.width, v * textureMid.image.height, 1, 1, renderer.getContext().RGBA, renderer.getContext().UNSIGNED_BYTE, pixelBuffer);

// renderer.getContext().bindFramebuffer(renderer.getContext().FRAMEBUFFER, null);

// console.log("alpha = ", pixelBuffer[3]);
/**
 * END crazy test
 */

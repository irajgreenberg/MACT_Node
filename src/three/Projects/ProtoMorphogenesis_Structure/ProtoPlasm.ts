...
import { ProtoOrganism_Structure } from "./ProtoMorphogenesis_Structure";
...
export class ProtoPlasm extends Group {
    ...
    */
    ...
    constructor(orgs: ProtoOrganism_Structure | ProtoOrganism_Structure[], zIndexDepthMin: number = 100, bounds: Vector3 = new Vector3(1400, 1000, 500)) {
        super();

        // handle single or array organism input
        // after the condtional array type used throughout class
        if (orgs instanceof ProtoOrganism_Structure) {
            this.orgs.push(orgs);
    ...
    */
    public addOrg(org: ProtoOrganism_Structure): void {
        this.orgs.push(org);
    }

    // Needs to be implemented
    // public swapZIndex(org1: ProtoOrganism_Structure, org2: ProtoOrganism_Structure) {
